import mapped_tag_dictionary_generator
import pprint
import csv
...
tag_dict = mapped_tag_dictionary_generator.dict_generator()

'''Change for different document scoring '''
doc = open('dev_output_mapped.csv', 'r')
...
f = open('dev_output_mapped_improved.csv', 'w')
